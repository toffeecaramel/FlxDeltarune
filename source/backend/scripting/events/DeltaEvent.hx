...
// https://github.com/CodenameCrew/CodenameEngine/blob/main/source/funkin/backend/scripting/events/CancellableEvent.hx
...
@:noCustomClass
class DeltaEvent implements IFlxDestroyable {
     ...
     * @param c Whether the scripts following this one should be called or not. (Defaults to `true`)
     */
